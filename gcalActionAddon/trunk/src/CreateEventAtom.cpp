/* dlvhex-GoogleCalendarActionAddon -- Google Calendar Action Addon for dlvhex.
 * 2010 Selen Başol, Ozan Erdem
 *
 * This file is part of dlvhex-GoogleCalendarActionAddon.
 *
 * dlvhex-GoogleCalendarActionAddon is free software; you can redistribute it
...
namespace dlvhex
{
  namespace googlecalendar
  {
    ...
    CreateEventAtom::CreateEventAtom(GoogleCalendarActionAddon& gcal) : gcal_addon(gcal)
    {
